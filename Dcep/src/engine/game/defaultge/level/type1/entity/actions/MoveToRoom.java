...
public class MoveToRoom implements ParamReceiver<StagePath> {

	public MoveToRoom(WalkBehaviorPack npack) {
		pack = npack;
		genBehavior();
		genBehavior2();
	}
